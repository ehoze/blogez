<?php
global $SES;
(!$SES->IsLogged()) ? header('Location:/blogez/konto/login/', true, 301) : '';
...
<section class="container py-5">
    ...
    <div class="posts-section">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="/blogez/konto/post/" class="btn btn-gradient">Dodaj nowy wpis</a>
        </div>
                    ...
                    <div class="col">
                        <div class="post-card">
                            <div class="card-body p-4">
                                ...
                                <a href="/blogez2/konto/post/edit/<?= $post['id'] ?>" class="btn btn-outline-gradient mt-3">
                                    Edytuj wpis
                                </a>
                            </div>
                        </div>
        ...
        <?php } else { ?>
            <div class="empty-state text-center py-5">
                ...
                <a href="/blogez/konto/post/" class="btn btn-gradient">Stwórz swój pierwszy wpis</a>
            </div>
        <?php } ?>
    </div>
</section>
